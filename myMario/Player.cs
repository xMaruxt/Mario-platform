...
namespace myMario
{
    class Player
    {
        ...
        public Player(ContentManager content)
        {
            ...
            texture_stand_right = content.Load<Texture2D>("Texture/texture_stand_right");
            texture_stand_left = content.Load<Texture2D>("Texture/texture_stand_left");
            texture_walk_right = content.Load<Texture2D>("Texture/texture_walk_right");
            texture_walk_left = content.Load<Texture2D>("Texture/texture_walk_left");
            texture_jump_left = content.Load<Texture2D>("Texture/texture_jump_left");
            texture_jump_right = content.Load<Texture2D>("Texture/texture_jump_right");
            texture_stand_right_mini = content.Load<Texture2D>("Texture/texture_stand_right_mini");
            texture_stand_left_mini = content.Load<Texture2D>("Texture/texture_stand_left_mini");
            texture_jump_right_mini = content.Load<Texture2D>("Texture/texture_jump_right_mini");
            texture_jump_left_mini = content.Load<Texture2D>("Texture/texture_jump_left_mini");
            texture_walk_right_mini = content.Load<Texture2D>("Texture/texture_walk_right_mini");
            texture_walk_left_mini = content.Load<Texture2D>("Texture/texture_walk_left_mini");
            texture_stand_right_fire = content.Load<Texture2D>("Texture/texture_stand_right_fire");
            texture_stand_left_fire = content.Load<Texture2D>("Texture/texture_stand_left_fire");
            texture_jump_right_fire = content.Load<Texture2D>("Texture/texture_jump_right_fire");
            texture_jump_left_fire = content.Load<Texture2D>("Texture/texture_jump_left_fire");
            texture_walk_right_fire = content.Load<Texture2D>("Texture/texture_walk_right_fire");
            texture_walk_left_fire = content.Load<Texture2D>("Texture/texture_walk_left_fire");
